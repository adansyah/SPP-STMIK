                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <center>
                            ...
                            <h1 style="font-family: bold arial, sans-serif;">STMIK Mardira Indonesia </h1>
                        </center>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-6">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="/kelas" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-4 col-6">
                        ...
                        <div class="small-box bg-danger">
                            ...
                            <a href="/pembayaran" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
